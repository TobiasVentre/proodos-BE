...
import { IPatchLandingPageDTO } from "@proodos/application/DTOs/LandingPage/IPatchLandingPageDTO";
...
describe("LandingPage services", () => {
  it("should create landing page service", async () => {
    ...
    landingPageRepository.create.mockResolvedValue({
      id_landing: 1,
      URL: "https://example.com",
      estado: "ACTIVO",
      segmento: "retail",
    ...
    expect(landingPageRepository.create).toHaveBeenCalledWith({
      id_landing: 0,
      URL: "https://example.com",
      estado: "ACTIVO",
      segmento: "retail",
  ...
  it("should update landing page via service", async () => {
    ...
    // Assert
    expect(landingPageRepository.update).toHaveBeenCalledWith({
      id_landing: 4,
      URL: "https://example.com",
      estado: "ACTIVO",
      segmento: "retail",
  ...
  it("should patch landing page", async () => {
    ...
    const dto: IPatchLandingPageDTO = { URL: "https://new.com" };
