...
export class PlanCommandRepository {
  ...
  async patchFull(id_plan: number, dto: PatchPlanFullDTO): Promise<Plan> {
    ...
    if (dto.segmento !== undefined) updatePayload.segmento = dto.segmento;
    if (dto.producto !== undefined) updatePayload.producto = dto.producto;
    if (dto.bonete !== undefined) updatePayload.bonete = dto.bonete;
    if (dto.nombre !== undefined) updatePayload.nombre = dto.nombre;
    if (dto.nombre_plan !== undefined) updatePayload.nombre_plan = dto.nombre_plan;
    if (dto.capacidad !== undefined) updatePayload.capacidad = dto.capacidad;
    ...
    if (dto.tag_1 !== undefined) updatePayload.tag_1 = dto.tag_1;
    if (dto.tag_2 !== undefined) updatePayload.tag_2 = dto.tag_2;
    if (dto.beneficio_1 !== undefined) updatePayload.beneficio_1 = dto.beneficio_1;
    if (dto.beneficio_2 !== undefined) updatePayload.beneficio_2 = dto.beneficio_2;
    if (dto.beneficio_3 !== undefined) updatePayload.beneficio_3 = dto.beneficio_3;
    if (dto.beneficio_4 !== undefined) updatePayload.beneficio_4 = dto.beneficio_4;
    if (dto.cta_1 !== undefined) updatePayload.cta_1 = dto.cta_1;
    if (dto.link_1 !== undefined) updatePayload.link_1 = dto.link_1;
    if (dto.cta_2 !== undefined) updatePayload.cta_2 = dto.cta_2;
    if (dto.link_2 !== undefined) updatePayload.link_2 = dto.link_2;
    if (dto.aumento !== undefined) updatePayload.aumento = dto.aumento;
    ...
    if (dto.promo_activa !== undefined) updatePayload.promo_activa = dto.promo_activa;
    if (dto.muestra_desde !== undefined) updatePayload.muestra_desde = dto.muestra_desde;
    ...
    if (dto.comercial_id !== undefined) updatePayload.comercial_id = dto.comercial_id;
    if (dto.telefono_0800 !== undefined) updatePayload.telefono_0800 = dto.telefono_0800;
    if (dto.icono_tag_1 !== undefined) updatePayload.icono_tag_1 = dto.icono_tag_1;
    ...
    if (dto.nombre_plan_tv !== undefined) updatePayload.nombre_plan_tv = dto.nombre_plan_tv;
    if (dto.grilla_canales !== undefined) updatePayload.grilla_canales = dto.grilla_canales;
    if (dto.icono_bonete !== undefined) updatePayload.icono_bonete = dto.icono_bonete;
    if (dto.precio_sin_iva !== undefined) updatePayload.precio_sin_iva = dto.precio_sin_iva;
