...
export class PlanMapper {
  static toDomain(model: PlanModel): Plan {
    return {
      ...
      capacidad_anterior:
        model.capacidad_anterior === null ? null : Number(model.capacidad_anterior),
      precio_full_price:
        model.precio_full_price === null ? null : Number(model.precio_full_price),
      ...
      precio_tv_digital:
        model.precio_tv_digital === null ? null : Number(model.precio_tv_digital),
      precio_tv_max:
        model.precio_tv_max === null ? null : Number(model.precio_tv_max),
      ...
      precio_no_cliente:
        model.precio_no_cliente === null ? null : Number(model.precio_no_cliente),
      ...
      precio_sin_iva:
        model.precio_sin_iva === null ? null : Number(model.precio_sin_iva),
    };
  }
}
