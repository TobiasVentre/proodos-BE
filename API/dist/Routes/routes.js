...
const buildRoutes = async (logger) => {
    ...
    routes.use("/landings", (0, LandingPageController_1.createLandingPageController)({
        ...
        generateLandingIndexService: useCases.landing.generateLandingIndex,
        ...
        updateLandingComponenteOrdenService: useCases.landing.updateLandingComponenteOrden,
    ...
    routes.use("/planes", (0, PlanController_1.createPlanController)({
        ...
        getPlansDataService: useCases.plan.getPlansData,
