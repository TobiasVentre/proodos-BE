...
exports.createLandingPageController = void 0;
const express_1 = require("express");
const ControllerErrors_1 = require("./ControllerErrors");
const createLandingPageController = ({ createLandingPageService, getLandingPageByIdService, getAllLandingPagesService, updateLandingPageService, patchLandingPageService, deleteLandingPageService, assignLandingComponenteService, unassignLandingComponenteService, getLandingComponentesService, }) => {
    const landingPageController = (0, express_1.Router)();
    /**
     * @openapi
     * /api/landings:
     *   get:
    ...
    landingPageController.get("/", async (req, res) => {
        ...
        try {
            ...
            return (0, ControllerErrors_1.handleControllerError)(res, error);
        }
    });
    /**
     * @openapi
    ...
    landingPageController.get("/:id", async (req, res) => {
        ...
        if (Number.isNaN(landingId) || landingId <= 0) {
            return (0, ControllerErrors_1.respondValidationError)(res, "Invalid id");
        }
        try {
    ...
    landingPageController.post("/", async (req, res) => {
        ...
        if (!URL || !estado || !segmento) {
            return (0, ControllerErrors_1.respondValidationError)(res, "Missing required fields", {
    ...
    landingPageController.patch("/:id", async (req, res) => {
        ...
        try {
            ...
            if (String(error?.message || "").includes("No fields provided")) {
                return (0, ControllerErrors_1.respondValidationError)(res, "No fields provided");
            }
            return (0, ControllerErrors_1.handleControllerError)(res, error);
        }
    });
    ...
    landingPageController.post("/:id/componentes", async (req, res) => {
        ...
        if (Number.isNaN(id_landing) || id_landing <= 0) {
            return (0, ControllerErrors_1.respondValidationError)(res, "Invalid landing id");
        }
        if (Number.isNaN(id_componente) || id_componente <= 0) {
            return (0, ControllerErrors_1.respondValidationError)(res, "Invalid id_componente");
        }
        try {
    ...
    landingPageController.delete("/:id/componentes/:id_componente", async (req, res) => {
        console.log(`[Controller] DELETE /landings/${req.params.id}/componentes/${req.params.id_componente}`);
        const id_landing = Number(req.params.id);
