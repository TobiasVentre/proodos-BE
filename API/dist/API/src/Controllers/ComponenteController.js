...
const createComponenteController = ({ createComponenteService, getAllComponentesService, getComponenteByIdService, patchComponenteService, deleteComponenteService, softDeleteComponenteService, getLandingsByComponenteService, assignComponenteHijoService, unassignComponenteHijoService, getComponenteTreeService, }) => {
    ...
    componenteController.post("/:id/hijos", async (req, res) => {
        ...
        if (Number.isNaN(id_hijo) || id_hijo <= 0) {
            return (0, ControllerErrors_1.respondValidationError)(res, "Invalid id_hijo");
        }
        try {
    ...
    componenteController.delete("/:id/hijos/:id_hijo", async (req, res) => {
        console.log(`[Controller] DELETE /componentes/${req.params.id}/hijos/${req.params.id_hijo}`);
        const id_padre = Number(req.params.id);
...
exports.createComponenteController = createComponenteController;
